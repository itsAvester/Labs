...
yes <- results <- data.frame(
  ...
  Misclassification = c(0.412,0.413,0.38,0.392,0.381,0.409,0.41,0.38,0.376,0.432,0.431,0.431,0.417,0.427,0.422),
  Sensitivity = c(0.657,0.655,0.549,0.612,0.571,0.482,0.685,0.576,0.640,0.591,0.979,0.979,0.906,0.930,0.776),
  Specificity = c(0.519,0.519,0.691,0.604,0.665,0.687,0.481,0.670,0.606,0.541,0.077,0.195,0.196,0.145,0.340))
